...
pdf.text Spree::Store.current.name, align: :center, style: :bold, size: 18
...
pdf.grid([0,3], [1,4]).bounding_box do
  ...
  pdf.text Spree.t(printable.document_type, scope: :print_invoice), align: :right, style: :bold, size: 14
  pdf.move_down 4
